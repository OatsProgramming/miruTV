...
type IAnimeInfoFiltered = Pick<IAnimeInfo, 'id' | 'title' | 'episodes' | 'cover' | 'description' | 'image' | 'status' | 'trailer' | 'nextAiringEpisode' | 'artwork'> & { episodes: IAnimeEpisodeFiltered[] }
